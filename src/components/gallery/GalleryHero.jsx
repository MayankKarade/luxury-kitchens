...
export default function GalleryHero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-brand-dark pt-28 sm:pt-36">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-7rem)] max-w-7xl flex-col justify-center px-4 pb-8 sm:px-10 md:px-16">
        <motion.div
          variants={stagger}
          initial="hidden"
          animate="visible"
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="mt-10 grid overflow-hidden rounded-lg border border-white/10 bg-black/35 backdrop-blur-xs sm:grid-cols-2 lg:grid-cols-4"
        >
